...
// Formulario vía comando /taskassign
...
// Interacción con el botón "Me lo asigno"
app.post("/slack/interactions", async (req, res) => {
  ...
  if (payload.type === "block_actions") {
    ...
    if (action.action_id === "assign_task") {
      ...
      const posterUsername = contextBlock?.elements[0]?.text?.match(/Publicado por: \*(.+?)\*/)?.[1];
      ...
      try {
        ...
        const userFound = usersList.data.members.find((u) => u.name === posterUsername);
